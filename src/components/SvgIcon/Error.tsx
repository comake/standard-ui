...
const Error: FC<IconProps> = ({ className }) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <path d="M12 9V13" stroke="#EF2D2D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 17H12.01" stroke="#EF2D2D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
