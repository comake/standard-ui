...
export const NavigationBarItem = forwardRef<HTMLLIElement | HTMLAnchorElement, NavigationBarItemProps>(
    (
        ...
        const _ref = (ref ?? localRef) as MutableRefObject<HTMLAnchorElement | HTMLLIElement>;
            ...
            return (
                <>
                    <div className={'flex items-center relative'}>
                        ...
                        {isIconButton ? null : (
                            <Typography variant="caption2" className={'left line-clamp-1 text-left'}>
                                {textLeft}
                            </Typography>
                        )}
                    </div>
        ...
        }, [Content, _ref, className, disabled, link, onClick, onContextMenu, style]);
